  ...
  return (
    <section className="panel">
      ...
      <div className="panelBody stack">
        ...
        <div className="field"><label>Rich body HTML</label><textarea className="textarea textareaTall" value={draft.bodyHtml} onChange={(event) => onDraftChange({ bodyHtml: event.target.value, updatedAt: new Date().toISOString() })} /></div>
      </div>
    </section>
  );
}
