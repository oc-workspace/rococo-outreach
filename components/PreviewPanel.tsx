    ...
    <section className="panel">
      ...
      <div className="panelBody stack">
        ...
        <div className="rowWrap">
          ...
          {confirmArmed && <button className="button buttonPrimary" onClick={onRealSend} disabled={campaignSending}>{campaignSending ? 'Sending...' : `Send ${renderedEmails.length} independent emails`}</button>}
